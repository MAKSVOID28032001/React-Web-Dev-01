...
import { faIndianRupeeSign, faTrashCan, faPen } from '@fortawesome/free-solid-svg-icons'
        ...
        <>
            {
                props.value.length === 0 ?
                    (
                        <h3 className="H3N">No Expense From {props.year} To {parseInt(props.year - 3)}</h3>
                    ) : (
                                        ...
                                        <div key={index} className="List-Item">
                                            ...
                                            <div className="Date-Price">
                                                ...
                                                <div className="Price-Box">
                                                    ...
                                                    <p><FontAwesomeIcon icon={faIndianRupeeSign} size="sm" style={{ color: "white", }} /></p>
                                                </div>
                                            </div>
                                            <div className="Btn-Box">
                                                <button className="BTN EDT" onClick={() => HandleEdit(item.eid)}>
                                                    <FontAwesomeIcon icon={faPen} style={{ color: "#ffffff", }} />
                                                </button>
                                                <button className="BTN DEL" onClick={() => props.onDelete(item.eid)}>
